    ...
    <>
      <section className="bg-muted/60">
        <div className="mx-auto w-full max-w-7xl px-4 py-20 sm:px-6">
          ...
          <h1 className="mt-4 max-w-4xl text-4xl font-black text-gray-900 dark:text-gray-100 sm:text-6xl">
      ...
      <section className="section-padding">
        <div className="mx-auto grid w-full max-w-7xl gap-5 px-4 sm:px-6 lg:grid-cols-2">
          <Card>
            <h2 className="text-2xl font-black text-gray-900 dark:text-gray-100">Mission</h2>
          ...
          <Card>
            <h2 className="text-2xl font-black text-gray-900 dark:text-gray-100">Vision</h2>
            <p className="mt-4 leading-7 text-slate-600 dark:text-slate-300">
      ...
      <section className="section-padding bg-muted/50">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
          <h2 className="text-3xl font-black text-gray-900 dark:text-gray-100">Core values</h2>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {values.map((value) => <Card key={value}><p className="font-bold text-gray-900 dark:text-gray-100">{value}</p></Card>)}
          </div>
        </div>
      </section>
      <section className="section-padding">
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2">
          <div>
            <h2 className="text-3xl font-black text-gray-900 dark:text-gray-100">Development process</h2>
            <div className="mt-8 grid gap-4">
              {processSteps.map((step, index) => (
                <Card key={step} className="flex gap-4">
                  ...
                  <p className="font-semibold text-gray-900 dark:text-gray-100">{step}</p>
                </Card>
              ))}
            </div>
          </div>
          <div>
            <h2 className="text-3xl font-black text-gray-900 dark:text-gray-100">Company story</h2>
            <div className="mt-8 grid gap-4">
              {timeline.map((item) => (
                <Card key={item.title}>
                  <p className="text-sm font-bold text-primary">{item.year}</p>
                  <h3 className="mt-2 text-xl font-bold text-gray-900 dark:text-gray-100">{item.title}</h3>
