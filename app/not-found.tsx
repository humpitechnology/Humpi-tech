  ...
  return (
    <section className="grid min-h-[70vh] place-items-center px-4 py-20 text-center">
      <div>
        ...
        <h1 className="mt-8 text-4xl font-black text-gray-900 dark:text-gray-100">Page not found</h1>
        <p className="mt-4 max-w-xl text-gray-600 dark:text-gray-300">The page may have moved, or the address may be incorrect. Return home or contact Humpi Technology for help.</p>
