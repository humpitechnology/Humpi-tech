    ...
    <section className="section-padding">
        ...
        <div>
          ...
          <div className="mt-8 grid gap-4">
            ...
            <Card>
              ...
              <p>{company.address}</p>
              <p className="mt-2 text-sm text-slate-500">{company.hours}</p>
            </Card>
          </div>
        </div>
        <Card>
          <h2 className="text-2xl font-black text-gray-900 dark:text-gray-100">Request a quote</h2>
      ...
      <div className="mx-auto mt-10 w-full max-w-7xl px-4 sm:px-6">
        <div className="min-h-72 rounded-lg border border-border bg-muted p-8">
          <p className="text-sm font-bold text-gray-900 dark:text-gray-100">Google Map Placeholder</p>
          <p className="mt-2 text-gray-600 dark:text-gray-300">
            Embed the verified Google Maps iframe for Kolkata, West Bengal, India here after Maps
            API or embed approval.
          </p>
        </div>
      </div>
    </section>
