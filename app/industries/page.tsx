        ...
        <div className="mx-auto grid w-full max-w-7xl gap-5 px-4 sm:px-6 md:grid-cols-2 lg:grid-cols-3">
          {industries.map((industry) => (
            <Card key={industry.slug}>
              <h2 className="text-2xl font-black text-gray-900 dark:text-gray-100">{industry.title}</h2>
              <p className="mt-3 text-sm leading-6 text-gray-600 dark:text-gray-300">{industry.description}</p>
